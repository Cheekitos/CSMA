...
- **Remaster 2.0:** A full remaster is available, check the c-con discord. I havn't tried it yet, but it'll probably end up being the one I recommend playing (if you have the hardware to run it properly!)
